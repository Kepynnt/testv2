...
By : ${chalk.red('@KEVINGANTENG')} - ${chalk.blue('GANS BANGET/')}
...
`);
    ...
    const feature = rs.question('[+] Pilih Nomor Mex : ');
    ...
    if (feature == '1') {
        ...
        while (true) {
            ...
            if (!result) {
                ...
                console.log(`\r
Sabar Bro Delay!! 
${chalk.bgRed('BY KEVINGANS')}

😅☝  [${moment().format('HH:mm:ss')}]  -
→  ${chalk.magenta(`Negara By KEVINGANS : ${country}`)}
→  ${chalk.yellow(`Nama By KEVIN GANS : ${username}`)}
→  ${chalk.cyan(`Exp By KEVIN GANS: ${exp}`)}  
→  ${chalk.blue(`Tropy By KEVIN GANS : ${trophy}`)}  
→  ${chalk.bgRed(`Crown By KEVIN GANS : ${crown}`)}
→  ${chalk.bgGreen(`Status : ✔ Gagal Tafi Boong`)}`);
        await delay(time);

            } else if (result == 'BANNED') {

                console.log(chalk.red(`[ ${moment().format('HH:mm:ss')} ] Mampus Kena Banned Memek ! !`));
                break;
